    ...
    <div className='isolate bg-white px-6 py-24 sm:py-32 lg:px-8'>
      ...
      <div className='mx-auto max-w-2xl text-center'>
        ...
        <p className='mt-2 text-lg leading-8 text-gray-600'>
          ...
          recommendations from people who share your tastes. Say goodbye to
          endless searching and hello to literary adventures that ignite your
          imagination. Your next great read is just a tap away!
        </p>
      </div>
      <form
        // action='#'
